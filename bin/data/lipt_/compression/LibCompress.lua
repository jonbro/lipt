...
function LibCompress:GetEncodeTable(reservedChars, escapeChars, mapChars)
	...
	local taken = {}
	for i=1, string.len(encodeBytes) do 
	...
	if #mapChars > 0 then
		...
		table.insert(decode_func_string, "str = str:gsub(self.decode_search"..tostring(escapeCharIndex)..", self.decode_translate"..tostring(escapeCharIndex)..");")
